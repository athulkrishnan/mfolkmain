...
//
while
    createOriginal = "Loading Image";
        do while points.reProcessLine, true, true
    trigger var img = new Image();
    poly.createOriginal = var createPolyMesh
    width while
    do createOriginal = var (poly.createOriginal)
